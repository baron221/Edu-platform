...
export async function POST(req: Request) {
    try {
        ...
        const { object } = await generateObject({
            ...
            2. For the 'category' field, you MUST choose from this specific list only: 'Web Development', 'Data Science', 'Design', 'Marketing', 'Mobile Development', 'Business', 'Mathematics', 'English', 'IELTS', 'Multilevel', 'Video Editing', 'Technology'.
